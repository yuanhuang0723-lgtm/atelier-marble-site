...
- A 390×844 unthrottled Chromium spot-check after this release showed large cold/warm variance: homepage LCP/TTFB 5.64s/2.66s on the first visit versus 0.78s/0.65s cached; vanity 4.86s/3.85s versus 0.67s/0.26s; CLS 0.0000 in these samples. PageSpeed Insights returned HTTP 429 with daily quota zero, and CrUX field data is unavailable. Treat these as lab observations, not a Core Web Vitals pass/fail.
