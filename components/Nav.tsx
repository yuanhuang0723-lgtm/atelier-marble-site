  ...
  return (
    <header className="site-nav fixed left-0 right-0 top-0 z-40 border-b border-[rgba(255,255,255,0.12)] bg-[rgba(247,241,232,0.84)] backdrop-blur-2xl">
      <div className="site-nav__inner container-luxury px-5 py-4 md:px-12 md:py-8">
        <div className="site-nav__bar flex w-full items-center justify-between gap-4 md:w-full 2xl:w-auto">
          ...
          <details className="site-nav__mobile 2xl:hidden">
        ...
        <nav className="site-nav__menu hidden items-center gap-8 whitespace-nowrap 2xl:flex">
          {navItems.map(([label, href]) => (
